                      ...
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                <a href="{{ url('admin/discount_code/edit/'.$value->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                <a href="{{ url('admin/discount_code/delete/'.$value->id) }}" class="btn btn-danger btn-sm">Delete</a>
                            </td>
