                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="sub_category_id" id="getSubCategory"
                                                    ...
                                                    @foreach ($getSubCategory as $subcategory)
                                                        <!-- Make sure $subCategories is passed from the controller -->
                                                        <option
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input type="text" class="form-control"
                                                                        placeholder="Name" name="size[100][name]">
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="form-control"
                                                                        placeholder="Price" name="size[100][price]">
                                                                </td>
                                                                <td>
                                                                    <button type="button"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="short_description" class="form-control editor" placeholder="Short Description">{{ $product->short_description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
...
@section('script')
    ...
    <script src="{{ url('public/assets/sortable/jquery-ui.js') }}" referrerpolicy="origin"></script>
    ...
    $(document).ready(function(){
        ...
        $('body').delegate('.AddSize', 'click', function() {
            var html = ' <tr id="DeleteSize' + i + '"> \n\
                                            <td>\n\
                                                <input type="text" class="form-control" placeholder="Name"  name="size[' +
                i + '][name]">\n\
                                            </td>\n\
                                            <td>\n\
                                                <input type="text" class="form-control" placeholder="Price" name="size[' +
                i + '][price]">\n\
                                            </td>\n\
