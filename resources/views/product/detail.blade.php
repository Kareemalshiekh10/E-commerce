@extends('layouts.app')
@section('style')
    <link rel="stylesheet" href="{{ url('assets/css/plugins/nouislider.css') }}">
@endsection
@section('content')
    <main class="main">
                            ...
                            <div class="product-gallery">
                                <figure class="product-main-image">
                                    ...
                                    @if (!empty($getProductImage) && !empty($getProductImage->getLogo()))
                                        <img id="product-zoom" src="{{ $getProductImage->getLogo() }}" alt="product image"
                                            data-zoom-image="{{ $getProductImage->getLogo() }}">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="product-desc-tab" role="tabpanel"
                        ...
                        <div class="container">
                            ...
                            <div id="product-description-content" contenteditable="true">
                                {!! $getProduct->description !!}
                            </div>
                            <!-- End Description Editable Div -->
                        </div><!-- End .container -->
                    </div><!-- .End .tab-pane -->
                    <div class="tab-pane fade" id="product-info-tab" role="tabpanel"
                        aria-labelledby="product-info-link">
                        <div class="container">
                            <!-- Additional Information Editable Div -->
                            <div id="product-additional-info-content" contenteditable="true">
                                {!! $getProduct->additional_information !!}
                            </div>
                            <!-- End Additional Information Editable Div -->
                        </div><!-- End .container -->
                    </div><!-- .End .tab-pane -->
                ...
                <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                    ...
                    <div class="product product-7">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{ url('assets/images/products/product-4.jpg') }}" alt="Product image"
                                    class="product-image">
                            </a>
                    ...
                    <div class="product product-7">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{ url('assets/images/products/product-6.jpg') }}" alt="Product image"
                                    class="product-image">
                            </a>
                    ...
                    <div class="product product-7">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{ url('assets/images/products/product-11.jpg') }}" alt="Product image"
                                    class="product-image">
                            </a>
                    ...
                    <div class="product product-7">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{ url('assets/images/products/product-10.jpg') }}" alt="Product image"
                                    class="product-image">
                            </a>
                    ...
                    <div class="product product-7">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{ url('assets/images/products/product-7.jpg') }}" alt="Product image"
                                    class="product-image">
                            </a>
