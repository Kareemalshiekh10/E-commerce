                            ...
                            <div class="product-details">
                                ...
                                <div class="product-details-action">
                                    ...
                                    <div class="details-action-wrapper">
                                        @if (!empty(Auth::check()))
                                        <a href="javascript:;" id="{{ $getProduct->id }}" class="btn-product btn-wishlist add_to_wishlist" title="Wishlist"><span>Add to
                                            Wishlist</span></a>
                                        @else
                    ...
                    <div class="product product-7">
                        ...
                        <div class="product-body">
                            ...
                            <h3 class="product-title"><a
                                href="{{ url($value->slug) }}">{{ $value->title }}</a></h3><!-- End .product-title -->
                            <div class="product-price">
