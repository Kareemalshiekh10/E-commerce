                        ...
                        <div class="col-lg-4">
                            <div class="intro-banners">
                                <div class="banner banner-display">
                                    ...
                                    <div class="banner-content">
                                        <h4 class="banner-subtitle text-darkwhite"><a href="#">Featured</a></h4><!-- End .banner-subtitle -->
                                        <h3 class="banner-title text-white"><a href="#">Outdoor Furniture <br>Summer Sale</a></h3><!-- End .banner-title -->
                                        <a href="#" class="btn btn-outline-white banner-link">Shop Now<i class="icon-long-arrow-right"></i></a>
                                    </div><!-- End .banner-content -->
                                </div><!-- End .banner -->
