                    ...
                    <div class="col-sm-12 col-lg-4 banners-sm">
                            ...
                            <div class="banner banner-display banner-link-anim col-lg-12 col-6">
                                <a href="{{ url($category->slug) }}">
                                    <img style="height: 300px;" src="{{ $category->getImage() }}" alt="{{ $category->name }}">
                                </a>
                                ...
                                <div class="banner-content banner-content-center">
                                    ...
                                    @if (!empty($category->button_name))
                                        <a href="{{ url($category->slug) }}" class="btn btn-outline-white banner-link">{{ $category->button_name }}<i
                                                class="icon-long-arrow-right"></i></a>
                                    @endif
                                </div><!-- End .banner-content -->
                            </div><!-- End .banner -->
        ...
        <div class="container">
            <div class="heading heading-center mb-6">
                ...
                <ul class="nav nav-pills nav-border-anim justify-content-center" role="tablist">
                    ...
                    @foreach ($getCategory as $category)
                        <li class="nav-item">
                            <a class="nav-link getCategoryProduct" data-val="{{ $category->id }}" id="top-{{ $category->slug }}-link" data-toggle="tab" href="#top-{{ $category->slug }}-tab" role="tab"
